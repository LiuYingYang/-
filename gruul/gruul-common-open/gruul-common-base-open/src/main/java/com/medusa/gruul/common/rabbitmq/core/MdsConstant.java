...
public class MdsConstant {
    ...
    //MQ选择器
    //分流选择器
    public static final String MQ_FL_EXCHANGE = "FL_EXC";
    //死信选择器
    public static final String MQ_DL_EXCHANGE = "DL_EXC";

    //选择键
    //分流慢通道选择键
    public static final String MQ_FL_SLOW_SEVERITIE = "FL_SLOW_SEV";
    ...
    /**
     *数据库操作是否异步 true 异步操作 false 同步操作
     */
    public static boolean DB_ASYNC = false;
