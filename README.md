...
一方面，这套SaaS系统研发投入巨大，迄今已超过300w人民币;另一方面，系统已经积攒了2000多商家用户，覆盖了超过80w终端用户，其中不乏【中国石油】、【贵州茅台】这类大公司和知名品牌基于本系统进行的二次开发和嵌入其原来系统。Smart shop拥有极高的改编性，随意拖拽组件和模型驱动的逻辑来创建程序，由此我们希望能让更多的程序员了解好的产品，经过反复讨论之后，我们决定把核心功能逐步开放出来。

通过gitee平台让赋予 Smart Shop 新生命，希望精心“养育”的代码可以在大家的认可和鞭策下发挥更大的价值。代码质量如何，懂行的人一看就会知道。真心希望得到大家中肯的建议和评价。我们励志，要做 **Java程序员的首选商城框架** ！！

### 项目介绍
Smart Shop是一款基于 **Spring Cloud** +MybatisPlus+XXL-JOB+redis+Vue的前后端分离的商城系统，采用轻量级稳定框架开发，优化核心、减少依赖，执行效率、扩展性、稳定性都很高。
