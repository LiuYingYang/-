...
经过了数以千计日夜的努力,笔歌1.0 笔歌2.0(更名为 启山智软社区团购系统)已陆续上线并取得一定的成绩。是一款系统稳定且经过反复线上论证和真实用户数据使用的Java社区团购系统。本着百尺竿头更进一步的想法 公司决定将启山智软社区团购系统全面面向社会。
...
### 项目介绍
		启山智软社区团购 是一款基于Spring Cloud 和 Vue.js的社区团购系统

		启山智软社区团购 包含了管理后台 城市合伙人(商家pc端) 区域团长后台 用户端小程序 手机H5等操作模块

		启山智软社区团购 针对用户痛点新增了 自定义装修(pc|小程序) 公众号接龙 引导页 区域团长 经营概况  自定义专区 直播 物流(发货单)模式 魔方装修组件 
...
### 必读
  :arrow_down: :arrow_down: 
	...
	注：如需深入了解业务功能信息请添加相关 运营负责人微信  wx:xcxqidiankeji。获取测试账号进行体验
		...
		开发者需知 : 启山智软社区团购我们只开放相关文档及项目介绍。如需了解源码费用情况请添加负责人wx咨询 本公司技术人员可提供相关服务，及设计文档 数据字典 操作使用教程  接口文档  部署教程文档等
