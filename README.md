注:该代码为1.0新零售商城版本 以下介绍为2.0新零售商城部分 
...
基于当前流行技术组合的前后端分离商城系统： Spring Boot+Spring Cloud+MybatisPlus+XXL-JOB+redis+Vue的前后端分离的商城系统， 包含商品管理、订单管理、运费模板、素材库、小程序直播、规格管理、会员管理、运营管理、内容管理、统计报表、权限管理、装修等功能，更适合企业或个人二次开发的 **新零售商城系统** ，是一款系统稳定且经过生产环境 **反复线上论证** 和 **真实用户数据使用** 的Java新零售系统。拥有完整下单流程的完全开源项目，本着百尺竿头更进一步的想法 公司决定将启山智软新零售系统全面面向社会。
...
### 小程序码
![小程序码](https://images.gitee.com/uploads/images/2021/0629/113432_6d79c8c8_8533008.jpeg "微信图片_20210629113413.jpg")
...
- 四：财务模块：对账、提现审核
- 五：用户模块：用户管理、会员卡、积分充值等
- 六：配送模块：运费管理、自动打印运单等
- 七：自定义装修模块：根据需求自定义装修首页、个人中心页、底部导航栏、商品列表页等
- 八：商超设置模块：绑定自己的公众号和小程序统一管理、店铺设置、下单设置、打印机连接配置、自动短信或公众号推送设置、支付和返利配置
